  ...
  <div class="feature-main col-sm-12 col-md-8">
    ...
    <div class="feature-row bottom-row">
      ...
      <div id="feature-6" class="feature col-xs-6">
        <!-- feature #6 -->
        <div class="cause-teaser <?php print $causes[6]['research_area_css_class']; ?>">
          <h2 class="teaser-title"><?php print $causes[6]['title']; ?></h2>
          <img class="cause-image-white" src="<?php print $causes[6]['research_area_icon_white']; ?>">
          <div class="lifestyle" style="background-image: url('<?php print $causes[6]['image']; ?>');"></div>
          <div class="jumbo-rail col-sm-6 col-md-4">
            <img class="researcher-image" src="<?php print $causes[6]['researcher_image']; ?>">
            <span class="researcher"><?php print $causes[6]['researcher_name']; ?></span>
            <p class="bio"><?php print $causes[6]['researcher_text']; ?></p>
            <div class="type">
              <img src="<?php print $causes[6]['research_area_icon_color']; ?>">
              <span class="<?php print $causes[6]['research_area_css_class']; ?>"><?php print $causes[6]['research_area_name']; ?></span>
            </div>
            <a class="cause-link" href="cause.php">See Cause <i class="bf-arrow bf-arrow-right"></i></a>
          </div>
        </div>
