...
<div class="card-event <?php print !(empty($event_type_modifier)) ? 'card-event--' . $event_type_modifier : ''; ?>">
    ...
    <div class="card-event__info-wrapper">
      <div class="card-event__info-left">
        ...
        <div class="card-event__date">
          <?php print drupal_render($content['field_event_date']) . ' (' . date('T') . ')'; ?>
        </div>
      </div>
  ...
  <div class="card-event__right-side">
    <?php if(!empty($short_date)) : ?>
      <div class="card-event__short-date">
        <div class="card-event__short-date-d"><?php print $short_date['day']; ?></div>
        <div class="card-event__short-date-m"><?php print $short_date['month']; ?></div>
      </div>
    <?php endif; ?>
    <div class="card-event__image"><?php print drupal_render($content['field_event_image']); ?></div>
    <?php if(!empty($event_type)): ?>
      <div class="card-event__type"><?php print $event_type; ?></div>
    <?php endif; ?>
    <?php if(!empty($hosts)) : ?>
      <div class="card-event__hosts">
        <div class="card-event__hosts-label">
          <?php print t('Hosts:'); ?>
        </div>
        <div class="card-event__hosts-content">
          <?php print $hosts; ?>
        </div>
      </div>
    <?php endif; ?>
    <div class="card-event__people">
      <div class="card-event__people-inner">
